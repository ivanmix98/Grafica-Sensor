...
public class OperacionsController {
    ...
    @GetMapping("/appCanvi/canviMoneda?dolar&yen")
    @ResponseBody
    public String getCanvi(@RequestParam (value="name")String name) {
        return "El tipus de canvi és de " + name;
    }
